...
from funcs import batch_ddim_sampling_mixp
...
def get_parser():
    ...
    parser.add_argument("--mode", default="base", type=str, help="which kind of inference mode: {'base'}")
    parser.add_argument("--ckpt_path", type=str, default=None, help="checkpoint path")
    parser.add_argument("--config", type=str, help="config (yaml) path")
    parser.add_argument("--prompt_file", type=str, default=None, help="a text file containing prompts")
...
def run_inference(args, gpu_num, gpu_no, **kwargs):
    ...
    for idx in range(0, n_rounds):
        ...
        ## inference
        batch_samples = batch_ddim_sampling_mixp(model, cond, noise_shape, args.n_samples, \
